...
{
	class SerializerService_3_0_0
	{
		public static string CATALOG_SYMANTIC_VERSION = "3.0.0";
		public static string CATALOG_DEAP_VERSION = "1.0.1";
		// Deap version 
		// Revision: 0.0.1
		//	- Added fields: 
		//		- ./DeapVersion, 
		...
		public static Catalog DeserializeIntoCatalog(JSONClass inputObject)
		{
		...
		public static JSONClass SerializeMutation(Mutation mutation)
		{
			var newJson = new JSONClass();
		...
		public static Mutation DeserializeIntoMutation(JSONClass inputObject)
		{
			var keys = inputObject.Keys.ToList();
		...
		public static JSONClass SerializeMorphSet(MorphMutation morphMutation)
		{
			var newJson = new JSONClass();
		...
		public static MorphMutation DeserializeIntoMorphMutation(JSONClass inputObject)
		{
			var keys = inputObject.Keys.ToList();
		...
		public static JSONClass SerializeClothingMutation(ClothingMutation clothingMutation)
		{
			var newJson = new JSONClass();
		...
		public static ClothingMutation DeserializeIntoClothingMutation(JSONClass inputObject)
		{
			var keys = inputObject.Keys.ToList();
		...
		public static JSONNode SerializeHairMutation(HairMutation hairMutation)
		{
			var newJson = new JSONClass();
		...
		public static JSONNode SerializeDynamicMutation(DynamicMutation mutation)
		{
			var newJson = new JSONClass();
		...
		public static DynamicMutation DeserializeIntoDynamicMutation(JSONClass inputObject)
		{
			var keys = inputObject.Keys.ToList();
		...
		public static bool? LoadBoolFromJsonStringProperty(JSONClass parentJsonObject, string propertyName, bool? defaultValue)
		{
			if (!PropExists(parentJsonObject, propertyName)) return defaultValue;
			var keys = parentJsonObject.Keys.ToList();
			var jsonNode = parentJsonObject.Childs.ElementAt(keys.IndexOf(propertyName));
		...
		public static JSONClass LoadObjectFromJsonObjectProperty(JSONClass parentJsonObject, string propertyName, JSONClass defaultValue)
		{
